App({
  ...
  isToday: function(date) {
    ...
    var now = new Date();
    // var dateDiff = now.getTime() - date.getTime();//时间差的毫秒数
  ...
  getSimplyTime: function(t) {
    ...
    var munites = time.getMinutes() < 10 ? '0' + time.getMinutes() : time.getMinutes();
    var result;
    var h_m = hours + ':' + munites;
    var y_m_d;
    if (year == nowYear) {
      y_m_d = month + '-' + date;
    } else {
